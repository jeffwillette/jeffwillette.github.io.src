...
updatedAt: 2019-02-28T16:11:07.333Z
categories:
  - Programming
  - Algorithms
  - Machine Learning
...
Multiplying the `all_theta` matrix with the `X'` matrix gives <InlineMath math="10 x 401 * 401 x 5000 = 10 x 5000"/> so
...
the last problem in the set was to make a prediction using a neural network [To be continued]...
