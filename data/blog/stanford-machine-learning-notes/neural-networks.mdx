...
updatedAt: 2019-04-20T11:33:32.675Z
categories:
  - Programming
  - Algorithms
  - Machine Learning
...
is <M i="[5000 x 401] * [401 x 25] = [5000 x 25]" />. I like to visualize this as 25 different interim predictions, or a
...
of <M i="\approx 0 \text{ or } \approx 1" />. If index 5 is approximately 1, then the prediction is that
