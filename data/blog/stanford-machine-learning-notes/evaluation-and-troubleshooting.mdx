...
updatedAt: 2019-04-19T03:50:13.702Z
categories:
  - Programming
  - Algorithms
  - Machine Learning
...
- try changing <M i="\lambda" /> values. increasing --> fixes high bias (underfitting). decreasing --> fixes
...
first split the training data into three seperate groups <M i="J_{\Theta train} \text{   } J_{\Theta cross
