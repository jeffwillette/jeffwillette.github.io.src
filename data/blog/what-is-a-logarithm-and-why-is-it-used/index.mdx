...
updatedAt: 2019-01-22T15:23:02.926Z
images:
...
you <Image2 align="left" width="65%" /> would go to the log table and go down the column on the left hand side until you hit 20 (some of these tables
...
to raise to to <InlineMath math="10^{.3010} = 2.00" /> in order to get 2.01? To find this, you would do the same
thing, but just move over to the next column (row 20 (which is 2) and column 1). Then you know
that <InlineMath math="10^.3032 = 2.01" />. It seems pretty archaic, but long multiplication problems were done this
...
<BlockMath math="= 257.3 x 14.84" />
<BlockMath math="= log(257.3) + log(14.84)" />
<BlockMath math="= log(2.573) + log(10^2) + log(1.484) + log(10^1)" />
<BlockMath math="then\; use\; the\; log\; table\; to\; find..." />
<BlockMath math="= .4099 + 2 + .1703 + 1" />
<BlockMath math="3.5802\; this\; is\; the\; exponent\; to\; raise\; 10\; to" />
<BlockMath math="10^{3.5802} = 3803.6" />
