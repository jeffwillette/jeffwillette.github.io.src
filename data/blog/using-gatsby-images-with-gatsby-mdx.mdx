...
published: true
createdAt: Sun, 20 Jan 2019 12:16:48 GMT
updatedAt: Sun, 20 Jan 2019 15:01:50 GMT
images:
...
My first inclination when trying to embed images in MDX via [gatby-mdx]() was to reach for [gatsby-remark-images]()
...
- load it with responsive settings like [gatsby-image]() does
...
<Image1 align="left" width="20%" />
<Image2 align="right" width="20%" />

The images on the left and right here were called with the code...

```typescript.tsx
<Image1 align="left" width="100px" />
<Image2 align="right" width="100px" />
```
