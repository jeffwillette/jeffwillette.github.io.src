...
updatedAt: 2019-04-18T13:14:20.811Z
categories:
  - Programming
  - Project Euler
  - Python
...
If `p` is the perimeter of a right angle triangle with integral length sides, <M i="a,b,c" /> there are
exactly three solutions for <M i="p = 120" />.

<M b="\{20,48,52\}, \{24,45,51\}, \{30,40,50\}" />

For which value of <M i="p ≤ 1000" />, is the number of solutions maximised?
