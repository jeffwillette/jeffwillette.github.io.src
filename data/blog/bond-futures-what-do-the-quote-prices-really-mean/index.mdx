...
updatedAt: 2019-04-19T04:47:31.491Z
images:
...
<M b="X*1.0002*\frac{3}{12}=$1,000,000" />
...
<M b="100'052 = 100+\frac{5}{32}+\frac{\frac{1}{4}}{32}" />

<M b="100'105 = 100+\frac{10}{32}+\frac{\frac{2}{4}}{32}" />

<M b="100'157 = 100+\frac{15}{32}+\frac{\frac{3}{4}}{32}" />

<M b="107'310 = 107+\frac{31}{32}+\frac{\frac{0}{4}}{32}" />
...
<M b="\$200,000/100'000 =\$2,000\ per\ point" />

<M b="\$2,000/32=\$62.5\ per\ \frac{1}{32}" />

<M b="\$62.5/4 =\$15.625\ per\ \frac{\frac{1}{4}}{32}" />
...
<M b="\$220,187.5 + (\$220,187.5 * R *2) = \$224,000" />
